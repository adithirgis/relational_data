...
![](img/inner_join.png){width="300" height="250"}
:::
...
![](img/left_join.png){width="300" height="250"}
...
![](img/right_join.png){width="300" height="250"}
:::
...
![](img/outer_join.png){width="300" height="250"}
...
b)    no difference both are same, just different syntax 

::: {.fragment .highlight-red}
c)    set operations are base R functions and joins are tidyverse functions 
:::

::: {.fragment .highlight-red}
d)    set operations have no keys but joins have keys  
:::
